...
import { TripEventTypes } from '../constants';
...
const createAddFormTemplate = ({ type, offers, destinations }) => {
  return (`
          ...
          <div class="event__type-wrapper">
            ...
            <div class="event__type-list">
              <fieldset class="event__type-group">
                ...
                ${Object.values(TripEventTypes).map((value) => createEventTypeItemTemplate(value, type)).join('')}
              </fieldset>
            </div>
          </div>
...
class EventAddFormView extends AbstractView {
  #type = null;
  #offers = null;
  #destinations = null;
  ...
  constructor({ type, offers, destinations, onFormSubmit }) {
    super();
    this.#type = type;
    this.#offers = offers;
